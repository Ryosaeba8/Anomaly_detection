...
def run_devnet(args):
    ...
    inlier_ids, outlier_ids = cutoff_unsorted(outlier_scores, th = 5)    
...
#            y_train = np.append(y_train, np.zeros((noises.shape[0], 1)))
    ...
    writeResults(filename+'_'+str(network_depth), n_samples_trn, n_outliers_org, n_outliers,
...
parser.add_argument("--known_outliers", type=int, default=500, help="the number of labeled outliers available at hand")
